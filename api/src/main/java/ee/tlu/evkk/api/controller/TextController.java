...
public class TextController {
  ...
  public String lemmad(String tekst) throws Exception {
      ProcessBuilder processBuilder = new ProcessBuilder("/usr/bin/python3", "../ui/public/python/lemmad.py");
  ...
  public String sonad(String tekst) throws Exception {
      ProcessBuilder processBuilder = new ProcessBuilder("/usr/bin/python3", "../ui/public/python/sonad.py");
      processBuilder.redirectErrorStream(true);
      String tulemus = "";
  ...
  public String laused(String tekst) throws Exception {
      ProcessBuilder processBuilder = new ProcessBuilder("/usr/bin/python3", "../ui/public/python/laused.py");
      processBuilder.redirectErrorStream(true);
      String tulemus = "";
